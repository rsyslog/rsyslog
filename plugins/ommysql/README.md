...
If TSAN reports block development, consider adding a suppression for the
`libmysqlclient` stack frames in `tests/tsan-rt.supp`, but keep the default
behavior for normal builds unchanged.
