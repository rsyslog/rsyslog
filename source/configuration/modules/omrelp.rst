`back to rsyslog module documentation <rsyslog_conf_modules.html>`__
...
documentation for `imrelp <imrelp.html>`__ (the server counterpart). 
...
module(load="omrelp") action(type="omrelp" target="centralserv"
port="2514")
...
See `imrelp <imrelp.html>`__, which documents them. 
...
$ModLoad omrelp \*.\* :omrelp:centralserv:2514
