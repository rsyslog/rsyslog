...
In this document, I am using :doc:`imtcp <../03_configuration/modules/imtcp>`, an input module that
...
:doc:`$RulesetParser <../03_configuration/ruleset/rsconf1_rulesetparser>` configuration directive.
...
See :doc:`http://www.rsyslog.com/doc/master/rainerscript/queue\_parameters.html <../06_reference/rainerscript/queue_parameters>`
for more details.
...
activated via the
:doc:`$RulesetCreateMainQueue <../03_configuration/ruleset/rsconf1_rulesetcreatemainqueue>`
directive.
...
.. toctree::
   ...
   ../_needs_triage/historical/multi_ruleset_legacy_format_samples
