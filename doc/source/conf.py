...
_cli_version = _get_sphinx_config_override('version')
_cli_release = _get_sphinx_config_override('release')
if _cli_version:
    version = _cli_version
if _cli_release:
    release = _cli_release

_rst_prolog_formatted = False
