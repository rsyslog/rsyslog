...
.. meta::
   :description: Receive syslog messages over TCP, with optional TLS and stream decompression.
   :keywords: rsyslog, imtcp, tcp, syslog, input, tls, stream compression, decompression, zlib, zstd
...
:doc:`omfwd <omfwd>` with ``compression.mode="stream:always"``. This is
...
- :ref:`imtcp-stream-decompression`
