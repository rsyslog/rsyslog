...
If they are modified, this happens as follows:
...
#. It replaces the **FromHost** value with the derived value from step 1
#. It replaces the **Severity** value with the derived value from step 2

Note that the placement of this module inside the configuration is
important. All actions before this module is called will work on the
unmodified message. All messages after its call will work on the
