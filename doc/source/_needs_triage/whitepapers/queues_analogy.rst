...
in-depth documentation on the ins and outs of rsyslog queues, some of the concepts are hard to grasp even for
...
If you have not done so before, it may be worth reading the Understanding rsyslog Queues documentation, which most
