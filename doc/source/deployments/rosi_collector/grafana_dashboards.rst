...
Monitor rsyslog client status and queue health:

- **Queue depth** - Messages waiting to be sent
- **Messages forwarded** - Rate of log forwarding
- **Processing errors** - Failed message processing
- **Last seen** - When each client last sent logs
