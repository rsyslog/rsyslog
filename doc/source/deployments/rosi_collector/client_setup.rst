...
Replace ``YOUR_COLLECTOR_DOMAIN`` with your ROSI Collector's domain.
...
.. code-block:: bash
   ...
   prometheus-target add CLIENT_IP:9100 host=CLIENT_HOSTNAME role=ROLE
...
For detailed rsyslog monitoring, enable impstats:

.. code-block:: bash

   sudo nano /etc/rsyslog.d/50-impstats.conf
