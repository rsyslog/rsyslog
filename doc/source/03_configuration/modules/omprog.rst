...
batches (transactions). When this
...
(:doc:`queue.workerThreads <../../06_reference/rainerscript/queue_parameters>` is
...
:doc:`queue.workerThreads <../../06_reference/rainerscript/queue_parameters>`
parameter). Moreover, if the action is associated to a
:doc:`disk-assisted queue <../../02_concepts/queues>`, an additional instance
