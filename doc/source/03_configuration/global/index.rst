...
-  **$DefaultRuleset** [name] - changes the default ruleset for unbound
   ...
   :doc:`using multiple rule sets in rsyslog <../../02_concepts/multi_ruleset>`.
- **$DefaultNetstreamDriver** <drivername>, the default
  :doc:`network stream driver <../../02_concepts/netstrm_drvr>` to use.
  Defaults to ptcp.
...
:doc:`queues in rsyslog <../../02_concepts/queues>`.
