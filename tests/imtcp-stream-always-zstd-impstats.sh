...
# Verifies imtcp stream:always accounting for zstd traffic; compressed bytes
...
input(type="imtcp" address="127.0.0.1" name="streamstats" port="0" listenPortFileName="'$RSYSLOG_DYNNAME'.tcpflood_port"
