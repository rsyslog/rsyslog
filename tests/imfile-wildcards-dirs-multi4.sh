...
do
	...
	do
		...
		./inputfilegen -m 100 > $RSYSLOG_DYNNAME.input.dir$i/dir$j/testdir/su$j/bd$j/ir$j/file.logfile
	done
	...
	check_spool_count $IMFILEINPUTFILES "$(stat -c "%n: %i" $RSYSLOG_DYNNAME.input.dir*/dir*/testdir/su*/bd*/ir*/file.logfile)"
