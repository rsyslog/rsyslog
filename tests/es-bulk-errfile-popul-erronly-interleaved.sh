...
echo ===============================================================================
echo \[es-bulk-errfile-popul-erronly-interleaved\]: basic test for elasticsearch functionality
...
source $srcdir/diag.sh startup es-bulk-errfile-popul-erronly-interleaved.conf
