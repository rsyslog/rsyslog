...
echo -n '<167>Mar  6 16:57:54 172.20.245.8 test: msgnum:0 X test message' | tr X '\000' | nc 127.0.0.1 13514
echo -n '<167>Mar  6 16:57:54 172.20.245.8 Xtest: msgnum:1 test message' | tr X '\000' | nc 127.0.0.1 13514
