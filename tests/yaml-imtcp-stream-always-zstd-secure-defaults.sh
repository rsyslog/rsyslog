...
check_not_present "${old_unlimited_warning}" "${RSYSLOG_DYNNAME}.yaml-warn-omitted.log"
...
check_not_present "${old_unlimited_warning}" "${RSYSLOG_DYNNAME}.yaml-backcompat-omitted.log"
