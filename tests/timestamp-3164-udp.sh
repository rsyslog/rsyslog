...
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Apr  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>May  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Jun  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Jul  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Aug  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Sep  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Oct  6 16:57:54 172.20.245.8 TAG: MSG\""
. $srcdir/diag.sh tcpflood -m1 -T "udp" -M "\"<167>Nov  6 16:57:54 172.20.245.8 TAG: MSG\""
